...
export default {
  ...
  axios: {
    ...
    browserBaseURL: process.env.NODE_ENV !== 'production' ? "https://polkadot.api.subscan.io" : "http://127.0.0.1:4399"
  },

  proxy: {
    "/api": {
      target: "https://polkadot.api.subscan.io", //"http://127.0.0.1:4399", // 接口的域名
      secure: false,
      changeOrigin: true,
      pathRewrite: {
        "^/api": "/api"
